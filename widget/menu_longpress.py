...
def _free_memory_before_run(keep_modules=("sys","gc","os","time","math","touch")):
    import sys, gc
...
class LongPressGuard:
    ...
    """
    def __init__(self, tp, threshold_ms=1200, poll_ms=35):
        self.tp = tp
...
def run_script(path):
    ...
    _guard = LongPressGuard(tp_singleton, threshold_ms=1200, poll_ms=35) if tp_singleton is not None else None
