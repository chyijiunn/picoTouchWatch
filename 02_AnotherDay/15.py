...
def walkandRun():
    global walknum , runnum , walkTARGET , runTARGET
    ...
    bat_remain = (reading - 2.25 ) / (2.68-2.25)  #(測得電壓-終止電壓)除以(飽和電壓-終止電壓)
...
def refresh():
    ...
    LCD.fill_rect(113,173,10,10,BG)#中圈
...
#中圈環狀
Ring(120,180,2,23,color(0,255,0))
while True:
